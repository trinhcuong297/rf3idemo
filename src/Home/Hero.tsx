        ...
        <div className="mx-auto max-w-screen-xl px-4 py-4 md:py-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              ...
              >
                {langSet === 'VN'
                  ? `RF3i là viết tắt của Radio Frequency Instrumentation and Industrial Informatics. Nhóm nghiên cứu RF3i thuộc Bộ môn Kỹ thuật đo và Tin học công nghiệp - Viện Điện (nay thuộc khoa Tự động hóa, Trường Điện – Điện tử, Đại học Bách Khoa Hà Nội). Nhóm nghiên cứu được thành lập năm 2014, do PGS. Lê Minh Thùy phụ trách quản lý và hướng dẫn.`
